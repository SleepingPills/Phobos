        ...
        {
            {
                "bigmap", new MapZone(
                    new()
                    {
                        { "ZoneDormitory", new BuiltinZone(new Range(250, 300), new Range(-0.25f, 0.75f)) },
                        { "ZoneScavBase", new BuiltinZone(new Range(350, 400), new Range(-0.25f, 0.75f)) },
                        { "ZoneOldAZS", new BuiltinZone(new Range(100, 150), new Range(-0.25f, 0.25f)) },
                        { "ZoneGasStation", new BuiltinZone(new Range(100, 150), new Range(-0.25f, 0.5f)) },
                    },
                    [
                        new CustomZone(new Vector2(-200, -100), new Range(350, 400), new Range(-0.25f, 0.75f)),
            ...
            { "Sandbox_high", new MapZone([], []) },
            {
                "Interchange", new MapZone(
                    new()
                    {
                        { "ZoneCenter", new BuiltinZone(new Range(350, 400), new Range(-0.5f, 0.75f)) }
                    },
                    []
                )
            },
            ...
            { "Labyrinth", new MapZone([], []) },
            {
                "Lighthouse", new MapZone(
                    new()
                    {
                        { "Zone_LongRoad", new BuiltinZone(new Range(350, 450), new Range(-0.5f, 0.75f)) },
                        { "Zone_Chalet", new BuiltinZone(new Range(150, 200), new Range(-0.25f, 0.25f)) },
                        { "Zone_Village", new BuiltinZone(new Range(400, 450), new Range(-0.25f, 0.75f)) }
                    },
                    []
                )
            },
            {
                "RezervBase", new MapZone(
                    new()
                    {
                        { "ZoneSubStorage", new BuiltinZone(new Range(100, 150), new Range(-0.25f, 0.5f)) },
                        { "ZoneBarrack", new BuiltinZone(new Range(100, 150), new Range(-0.25f, 0.5f)) }
                    },
                    []
                )
            },
            {
                "Shoreline", new MapZone(
                    new()
                    {
                        { "ZoneSanatorium1", new BuiltinZone(new Range(350, 400), new Range(-0.25f, 0.5f)) },
                        { "ZoneSanatorium2", new BuiltinZone(new Range(350, 400), new Range(-0.25f, 0.5f)) }
                    },
                    []
                )
            },
