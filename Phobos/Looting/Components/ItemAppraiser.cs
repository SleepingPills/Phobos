...
namespace Phobos.Looting.Components
{
    public class ItemAppraiser
    {
        ...
        public void Init()
        {
            Log = LootingSystem.ItemAppraiserLog;

            if (LootingSystem.UseMarketPrices.Value)
            {
        ...
        {
            bool valueFromMods = LootingSystem.ValueFromMods.Value;
            if (LootingSystem.UseMarketPrices.Value && MarketData != null)
            {
